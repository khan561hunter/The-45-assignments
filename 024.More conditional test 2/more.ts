...
//For False : 
console.log(("Black" as string) !== 'Black');
...
console.log("numerical true test for inequality",(6 as number) !== 8);

//numerical test of equality and inequality (false) : 
console.log("numerical false test for equality: ",(5 as number) == 4);
console.log("numerical false test for inequality: ",(5 as number) !== 5);
...
//for true :
let array : string[] = ['books','pencils','pen'];
...
let array2 : string[] = ['pink','purple','blue','black'];
let $found=false;
